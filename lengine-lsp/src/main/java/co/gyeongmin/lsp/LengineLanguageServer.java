 ...
 */
public class LengineLanguageServer implements LanguageServer, LanguageClientAware {
    ...
    public LengineLanguageServer() {
        this.textDocumentService = new LengineTextDocumentService(this);
        this.workspaceService = new LengineWorkSpaceService(this);
    }
    ...
    public void initialized(InitializedParams params) {
        ...
        if (isDynamicCompletionRegistration()) {
            ...
            languageClient.registerCapability(new RegistrationParams(Collections.singletonList(completionRegistration)));
        }
    }
